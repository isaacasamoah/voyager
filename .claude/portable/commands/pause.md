...
- `/pause + /team` - Full team reflection session
- `/pause + /kai + /marcus` - Specific members reflecting together
- `/pause` alone - Claude as reflection partner
...
**Use with team members for domain-specific reflection:**

- `/pause + /team` - Full team reflection & consolidation
- `/pause + /zara` - Reflect on AI behavior design & prompts
- `/pause + /marcus` - Reflect on backend architecture
- `/pause + /kai` - Reflect on full-stack implementation
- `/pause + /jordan` - Reflect on UX/design decisions
- `/pause + /kai + /marcus` - Reflect on full-stack + backend together
- `/pause + /nadia` - Reflect on business systems & operations

**Each team member reflects in their domain:**
- Guide exploration of existing code
- Ask revealing questions
- Help identify patterns and anti-patterns
- Support thoughtful refactoring decisions
