      ...
      <div className="bg-white p-8 rounded-xl shadow-xl max-w-md w-full">
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-[30px] hover:scale-105 transition-transform"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-[#0077B5] text-white rounded-[30px] hover:scale-105 transition-transform"
          >
