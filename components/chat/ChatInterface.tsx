        ...
        <div className="w-64 bg-white border-r border-gray-100 flex flex-col">
          ...
          <div className="px-3 py-3 border-t border-gray-100">
            ...
            <button
              ...
              className="w-full py-1.5 px-2 text-xs text-gray-500 hover:text-careersy-black hover:bg-gray-50 rounded transition-colors text-left"
            >
              Logout
            </button>
          </div>
          ...
          <div className="w-[60%] mx-auto space-y-3">
            ...
            <div className="relative flex items-center gap-2">
              ...
              <button
                ...
                title="Add files for review and context"
              >
